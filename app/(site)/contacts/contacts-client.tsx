          ...
          <div className="board-grid">
            ...
            <div className="address-card">
              ...
              <div className="gps-coords">
                ...
                <span>{CONTACTS.coordinates.lat}° N</span>
                <span>{CONTACTS.coordinates.lng}° E</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="map-frame" role="img" aria-label="Карта розташування NICE.car.if">
            ...
            <div className="map-coords" aria-hidden>
              <span className="live">GPS</span>
              <span>{CONTACTS.coordinates.lat}° N · {CONTACTS.coordinates.lng}° E</span>
            </div>

            <div className="map-actions">
              <a href={CONTACTS.googleMaps} target="_blank" rel="noopener noreferrer" className="btn-sm primary">
